...
import 'package:audiobooks_app/resources/books_db_provider.dart';
import 'package:audiobooks_app/resources/models/book.dart';
...
class CustomAudioPlayer extends BaseAudioHandler
  ...
  Future prepare() async {
    ...
    mediaItem.add(item);
    await _player
        .setAudioSource(AudioSource.uri(Uri.parse(audiofiles[index!].url!)));
