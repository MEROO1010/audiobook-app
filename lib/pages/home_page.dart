import 'package:audiobooks_app/pages/book_details.dart';
import 'package:audiobooks_app/resources/models/models.dart';
import 'package:audiobooks_app/resources/notifiers/audio_books_notifier.dart';
import 'package:audiobooks_app/widgets/book_grid_item.dart';
...
class HomePageState extends State<HomePage> {
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) => BookGridItem(
                    ...
                    onTap: () => _openDetail(context, notifier.topBooks[index]),
                  ),
  ...
  void _openDetail(BuildContext context, Book book) {
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => DetailPage(book)));
  }
}
